...
2. Comparar el contenido frecuencial de referencia mediante la correlación cruzada tiempo-frecuencia


3. Definir el modelo.
    + 3.1 Convertir la matriz de correlación en una matriz simetrica que contenga las diferencias.
    
    + 3.2 Ejecutar un escalado multidimensional.
    
    + 3.3 Calcular las distancias entre los elementos.

4. Evalución del modelo
...
La metodología utilizada se basa en el uso de unas muestras de audio a modo de referencia que permitirán comprobar el funcionamiento correcto del modelo.

Tres conjuntos con una serie de caracteristas particulares a modo de referencia ayudan a determinar el correcto funcionamiento del modelo:
